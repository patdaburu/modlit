...
# -*- coding: utf-8 -*-
#
# modlit documentation build configuration file
#
...
latex_documents = [
    (master_doc, 'modlit.tex', 'modlit Documentation',
     'Pat Daburu', 'manual'),
]
...
man_pages = [
    (master_doc, 'modlit', 'modlit Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'modlit', 'modlit Documentation',
     author, 'modlit', 'One line description of project.',
     'Miscellaneous'),
]
